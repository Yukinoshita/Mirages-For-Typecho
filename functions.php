...
function themeConfig(Typecho_Widget_Helper_Form $form) {
    echo '<p style="font-size:16px;">感谢您使用 Mirages • <a href="https://github.com/Dalodd/Mirages-For-Typecho/wiki" target="_blank">主题帮助文档</a> • <a href="https://hran.me/mirages.html?theme_option&v=142dev2#comments" target="_blank">意见或建议</a></p>', '<p style="font-size:14px;">版本: 1.4.2dev2 <a id="mirages_update_link" href="https://github.com/Dalodd/Mirages-For-Typecho/releases" target="_blank"><span id="mirages_update_notification"></span></a></p><p style="font-size:14px;">　</p>', '<script src="//cdn.bootcss.com/jquery/2.2.1/jquery.min.js" type="text/javascript"></script>', '<script type="text/javascript">(function($){$.getJSON("https://api.hran.me/mirages/checkForUpdates?current=1.4.2dev2&callback=?",null,function(data){if(data.error_no!=1){$("#mirages_update_notification").css("color","#333").html("[你可以到这里查看主题的最新版本]");return}if(data.new_version_available){var message="[新版本 <span style = \\"color:#f96;\\">"+data.latest_version+"</span> 已可用]";var color=data.color||"#1abc9c";$("#mirages_update_notification").css("color",color).html(message)}else{$("#mirages_update_notification").css("color","#333").html("[当前已为最新版]")}})})(jQuery)</script>';
